        ...
        <div className='px-3 py-3 lg:px-5 lg:pl-3'>
            <div className='flex items-center justify-between'>
                <div className='flex items-center justify-start rtl:justify-end'>
                    ...
                    sm:hidden hover:bg-gray-100 focus:outline-none focus:right-2 focus:ring-gray-200
                     dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600' onClick={toggleSidebar}>
                        <HiOutlineMenuAlt2 className='text-2xl'/>
                    </button>
                    <a href="#" className='flex me-2 md:me-24'>
                ...
                <button className='dark:lg-slate-50 dark:text-slate-700 rounded-full p-2' onClick={toggleDarkMode}>
