...
import { shortcutlink } from '../contants'
        ...
        {shortcutlink.map((list, index) => (
            <div key={index} className='flex justify-between items-center cursor-pointer rounded-sm'>
                <div className='flex gap-4 items-center'>
                    <span className='bg-blue-200 p-2 rounded-full w-8 h-1 flex items-center justify-center dark:bg-gray-800 dark:text-gray-300'>
                        <list.icon/>
                    </span>
